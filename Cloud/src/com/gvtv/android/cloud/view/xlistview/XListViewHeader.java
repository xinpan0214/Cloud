 ...
 */
package com.gvtv.android.cloud.view.xlistview;
...
public class XListViewHeader extends LinearLayout {
	...
	public void setState(int state) {
		...
		case STATE_NORMAL:
			...
			xlistview_header_time.setText(formatTimeToStr(System.currentTimeMillis()));
			break;
		case STATE_READY:
			if (mState != STATE_READY) {
				mArrowImageView.clearAnimation();
